...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		String parent = line.substring(0, colonIndex); //u The substring of line that starts at char #0 and ends just before colonIndex. Check the API for 
		...
		else
		{
			...
			if (parentNode == null)
				throw new TreeException("data Not Found");//If the parent node wasn't found, there must have been something wrong in the 
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node2 == null)
			throw new TreeException("node 2 not found");//Throw TreeException with a useful message
